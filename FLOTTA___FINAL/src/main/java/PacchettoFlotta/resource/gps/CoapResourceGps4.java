...
public class CoapResourceGps4 extends CoapResource {

    private final static Logger logger = LoggerFactory.getLogger(CoapResourceGps4.class);
    private static final String OBJECT_TITLE = "GPS4";
    private static final Double SENSOR_VERSION = 0.1;

    private Gson gson;
    private GPSCar4 gps4;
    ...
    public CoapResourceGps4(String deviceId, String name, GPSCar4 gps4) {
        super(name);
        if (gps4 != null && deviceId != null) {
            this.gson = new Gson();
            ...
            getAttributes().addAttribute("rt", gps4.getType());
            getAttributes().addAttribute("if", CoreInterfaces.CORE_S.getValue());
            getAttributes().addAttribute("ct", Integer.toString(MediaTypeRegistry.APPLICATION_SENML_JSON));
           //getAttributes().addAttribute("ct", Integer.toString(MediaTypeRegistry.TEXT_PLAIN));

        } else {
            logger.error("Error occured in gps4");
        }

        this.gps4.addDataListener(new DataListener() {
            @Override
    ...
    public void handleGET(CoapExchange exchange) {
        ...
        try {
            ...
            exchange.setMaxAge(GPSCar4.UPDATE_PERIOD);
