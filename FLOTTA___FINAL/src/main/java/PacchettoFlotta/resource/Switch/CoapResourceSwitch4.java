...
public class CoapResourceSwitch4 extends CoapResource {

    private final static Logger logger = LoggerFactory.getLogger(CoapResourceSwitch4.class);
    private static final String OBJECT_TITLE = "Switch4";
    private Gson gson;
    private final Switch4 switchRawActuator;

    public CoapResourceSwitch4(String name, Switch4 switchRawActuator) {
        super(name);
