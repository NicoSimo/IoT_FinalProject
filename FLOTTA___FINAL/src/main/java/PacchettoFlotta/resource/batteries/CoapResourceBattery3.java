...
public class CoapResourceBattery3 extends CoapResource {

    private final static Logger logger = LoggerFactory.getLogger(CoapResourceBattery3.class);
    private static final String OBJECT_TITLE = "Battery3";
    private static final Double SENSOR_VERSION = 0.1;

    private final String UNIT = "%";
    private Battery3 battery3;
    private String deviceId;
    private ObjectMapper objectMapper;

    private double updatedBatteryLevel = 99;

    public CoapResourceBattery3(String deviceId, String name, Battery3 battery3){
        super(name);

        if (battery3!=null && deviceId!=null){
            ...
            getAttributes().addAttribute("rt", battery3.getType());
        ...
        this.battery3.addDataListener(new DataListener() {
            @Override
    ...
    private Optional<String> getJsonSenmlResponse(){
        try {
            ...
            senMLRecord.setT(this.battery3.getTimestamp());
    ...
    public void handleGET(CoapExchange exchange) {
        ...
        */
        try {
            ...
            exchange.setMaxAge(Battery3.UPDATE_TIME);
