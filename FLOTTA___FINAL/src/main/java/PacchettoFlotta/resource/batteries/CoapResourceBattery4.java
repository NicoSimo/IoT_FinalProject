...
public class CoapResourceBattery4 extends CoapResource {

    private final static Logger logger = LoggerFactory.getLogger(CoapResourceBattery4.class);
    private static final String OBJECT_TITLE = "Battery4";
    private static final Double SENSOR_VERSION = 0.1;

    private final String UNIT = "%";
    private Battery4 battery4;
    private String deviceId;
    private ObjectMapper objectMapper;

    private double updatedBatteryLevel = 99;

    public CoapResourceBattery4(String deviceId, String name, Battery4 battery4){
        super(name);

        if (battery4!=null && deviceId!=null){
            ...
            getAttributes().addAttribute("rt", battery4.getType());
        ...
        this.battery4.addDataListener(new DataListener() {
            @Override
    ...
    private Optional<String> getJsonSenmlResponse(){
        try {
            ...
            senMLRecord.setT(this.battery4.getTimestamp());
    ...
    public void handleGET(CoapExchange exchange) {
        ...
        */
        try {
            ...
            exchange.setMaxAge(Battery4.UPDATE_TIME);
