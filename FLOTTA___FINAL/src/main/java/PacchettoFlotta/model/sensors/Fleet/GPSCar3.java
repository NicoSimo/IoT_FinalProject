...
public class GPSCar3 extends SmartObject<GPSModel> {

    private static final Logger logger = LoggerFactory.getLogger(GPSCar3.class);

    public static final String RESOURCE_TYPE = "gps.sensor";
    public static final String SENSOR_ID = "iot.sensor.gps3";

    private static final String GPX_FILE_NAME = "tracks/HomeTosano.gpx";

    public static final long UPDATE_PERIOD = 5000; //5 Seconds
    ...
    public GPSCar3() {
        super(GPSCar3.RESOURCE_TYPE, GPSCar3.SENSOR_ID);
        init();
    }

    public GPSCar3(String type, String id) {
        super(type, id);
        init();
    }
            ...
            this.updateTimer.schedule(new TimerTask() {
                ...
                public void run() {
                    ...
                    if(wayPointListIterator.hasNext()){
                        ...
                        if (currentWayPoint.getLatitude().doubleValue() ==  45.15396 && currentWayPoint.getLongitude().doubleValue() == 11.18457) {
                            try {
                                Thread.sleep(10000);
    ...
    public static void main(String[] args) {
        GPSCar3 GPS1Resource = new GPSCar3();
