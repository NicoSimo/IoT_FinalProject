...
public class Switch4 extends SmartObject<Boolean> {

    public static final String SENSOR_ID = "Switch4";
    ...
    private static final Logger logger = LoggerFactory.getLogger(Switch4.class);

    public Switch4(String vehicle, String model) {
        super(vehicle, model);
        this.value = false;
    }
    public Switch4(){
        super("Renault", Switch4.SENSOR_ID);
    }
    ...
    public static void main(String[] args) {
        ...
        Switch4 rawResource = new Switch4("Renault", SENSOR_ID);
