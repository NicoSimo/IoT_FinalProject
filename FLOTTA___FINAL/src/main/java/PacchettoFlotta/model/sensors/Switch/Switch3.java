...
public class Switch3 extends SmartObject<Boolean> {

    public static final String SENSOR_ID = "Switch3";
    ...
    private static final Logger logger = LoggerFactory.getLogger(Switch3.class);

    public Switch3(String vehicle, String model) {
        super(vehicle, model);
        this.value = false;
    }
    public Switch3(){
        super("Renault", Switch3.SENSOR_ID);
    }
    ...
    public static void main(String[] args) {
        ...
        Switch3 rawResource = new Switch3("Renault", SENSOR_ID);
