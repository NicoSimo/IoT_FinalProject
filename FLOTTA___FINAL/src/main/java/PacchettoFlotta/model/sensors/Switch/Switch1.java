...
public class Switch1 extends SmartObject<Boolean> {

    public static final String SENSOR_ID = "Switch1";

    private long timestamp;
    private boolean value;


    private static final Logger logger = LoggerFactory.getLogger(Switch1.class);

    public Switch1(String vehicle, String model) {
        super(vehicle, model);
        this.value = false;
    }
    public Switch1(){
        super("Renault", Switch1.SENSOR_ID);
    }
    ...
    public static void main(String[] args) {
        ...
        Switch1 rawResource = new Switch1("Renault", SENSOR_ID);
